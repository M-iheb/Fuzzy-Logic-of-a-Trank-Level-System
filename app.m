...
% Last Modified by GUIDE v2.5 22-Jan-2023 14:43:19
...
liquid-leve=str2double (get(hObject,'string'));
handles.liquid-level=liquid-level
guidata (hObject,handles);
...
out=evalfis([handles.liquid-level],[handles.Rate], fis);
fis=readfis('Trank level system2 5 rules.fis');
set(handles.edit3,'string',out);
if out < -10
    set-(handles.edit3,'string',' close-fast')
if -10 < out < 10
     set-(handles.edit3,'string','  No-change')
end
else 
     set-(handles.edit3,'string','  open-fast')
end
